...
```
cd existing_repo
git remote add origin https://git.pef.mendelu.cz/location-based-services/ebc-va1-ls2023/xpacako1.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.pef.mendelu.cz/location-based-services/ebc-va1-ls2023/xpacako1/-/settings/integrations)
